...
var init_tree_sitter = __esm(() => {
  ...
  isCaptureStep = __name((step) => step.type === "capture", "isCaptureStep");
  isStringStep = __name((step) => step.type === "string", "isStringStep");
  QueryErrorKind = {
    Syntax: 1,
    NodeName: 2,
    FieldName: 3,
...
var require_tree_sitter = __commonJS((exports, module2) => {
  module2.exports = "B:/~BUN/root/tree-sitter-3jzf13jk.wasm";
});

// ../../node_modules/.bun/@opentui+core@0.1.92+8e67d58793ed4a15/node_modules/@opentui/core/parser.worker.js
init_tree_sitter();
