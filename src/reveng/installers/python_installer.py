        ...
        try:
            result = subprocess.run(
                [
                    sys.executable,
                    "-c",
                    f"import {self.package_name}; print({self.package_name}.__version__)",
                ],
                capture_output=True,
                text=True,
                timeout=10,
...
"""
    ...
    def get_uncompyle6_command(self, pyc_file: str, output_file: str) -> list:
        ...
        return [sys.executable, "-m", "uncompyle6", "-o", output_file, pyc_file]
    ...
    def get_decompyle3_command(self, pyc_file: str, output_file: str) -> list:
        ...
        return [sys.executable, "-m", "decompyle3", "-o", output_file, pyc_file]
