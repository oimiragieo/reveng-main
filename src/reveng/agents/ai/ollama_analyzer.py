...
class OllamaAnalyzer:
    ...
    def __init__(
        ...
        logger.info(
            f"Config: timeout={timeout}s, temperature={temperature}, max_tokens={max_tokens}"
        )
    ...
    def analyze_function(
        self, function_code: str, function_name: str, context: Optional[Dict] = None
    ) -> AnalysisResult:
        """
    ...
    def _build_analysis_prompt(
        self, function_code: str, function_name: str, context: Optional[Dict]
    ) -> str:
