  ...
  try {
    ...
    const stats = {
      ...
      websocket: websocketService.getStats
        ...
        : { connections: 0 },
      analysis: {
        total: analysisService.analysisHistory
          ? analysisService.analysisHistory.size
          : 0,
        active: analysisService.activeAnalyses
          ? analysisService.activeAnalyses.size
          : 0,
      },
    };
    ...
    const health = {
      ...
      services: {
        analysis: {
          ...
          activeJobs: analysisService.activeAnalyses
            ? analysisService.activeAnalyses.size
            : 0,
          totalJobs: analysisService.analysisHistory
            ? analysisService.analysisHistory.size
            : 0,
        },
        websocket: {
