...
class ToolchainChecker:
    ...
    def _generate_summary(self):
        ...
        available_packages = sum(
            1 for r in self.results["python_packages"].values() if r["available"]
        )
    ...
    def _print_summary(self):
        ...
        print("-" * 60)
        print(
            f"Compilers: {summary['compilers']['available']}/{summary['compilers']['total']} available"
        )
        print(
            f"Python Packages: {summary['python_packages']['available']}/{summary['python_packages']['total']} available"
        )
        print(
            f"Optional Tools: {summary['optional']['available']}/{summary['optional']['total']} available"
        )
        print()
    ...
    def show_fix_instructions(self):
        ...
        missing_packages = [
            name
            for name, result in self.results["python_packages"].items()
