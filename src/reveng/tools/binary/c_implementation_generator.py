...
class CImplementationGenerator:
    ...
    def _generate_body(
        ...
        if category == "memory_alloc":
            ...
            body = template.format(str1=str1, str2=str2, error_value=error_value)
            ...
            body = template.format(error_value=error_value, return_value=return_value)
            ...
            body = template.format(
                condition=condition, error_value=error_value, return_value=return_value
            )
    ...
    def save_implementations(self, implementations: Dict[str, str], output_dir: Path):
