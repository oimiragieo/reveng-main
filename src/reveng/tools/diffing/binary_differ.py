...
class BinaryDiffer:
    ...
    def diff(
        self, binary_v1_path: str, binary_v2_path: str, deep_analysis: bool = False
    ) -> DiffResult:
        """
        ...
        for func_v1, func_v2 in matched_by_name.items():
            similarity = self._calculate_function_similarity(
                analysis_v1["functions"][func_v1], analysis_v2["functions"][func_v2]
            )
    ...
    def _match_by_name(
        self, functions_v1: Dict[str, Any], functions_v2: Dict[str, Any]
    ) -> Dict[str, str]:
    ...
    def _calculate_function_similarity(
        self, func1_data: Dict[str, Any], func2_data: Dict[str, Any]
    ) -> float:
