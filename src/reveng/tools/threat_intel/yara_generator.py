...
class YARAGenerator:
    ...
    def extract_strings(
        self, file_path: str, min_length: int = 8, max_strings: int = 50
    ) -> List[str]:
        """
    ...
    def find_unique_strings(
        self, strings: List[str], analysis_results: Optional[Dict[str, Any]] = None
    ) -> List[str]:
        """
    ...
    def extract_byte_patterns(
        self, file_path: str, pattern_length: int = 16, max_patterns: int = 10
    ) -> List[str]:
        """
