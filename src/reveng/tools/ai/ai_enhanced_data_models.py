...
class UniversalAnalysisResult:
    ...
    def get_risk_level(self) -> RiskLevel:
        ...
        elif self.corporate_exposure and self.corporate_exposure.risk_level in [
            RiskLevel.HIGH,
            RiskLevel.CRITICAL,
        ]:
            return self.corporate_exposure.risk_level
        elif self.threat_intelligence and self.threat_intelligence.threat_level in [
            RiskLevel.HIGH,
            RiskLevel.CRITICAL,
        ]:
...
class EvidenceTracker:
    ...
    def get_confidence_for_finding(self, finding_id: str) -> float:
        ...
        related_evidence = [
            e for e in self.evidence_chain if e.metadata.get("finding_id") == finding_id
        ]
