...
class ComprehensiveReportingSystem:
    ...
    def generate_comprehensive_report(self, analysis_results: Dict[str, Any]) -> Dict[str, str]:
        ...
        try:
            ...
            logger.info(
                f"Comprehensive report generation completed. {len(generated_reports)} files generated."
            )
    ...
    def generate_live_demonstration_package(self, analysis_results: Dict[str, Any]) -> str:
        ...
        self._generate_presentation_slides(analysis_results, demo_dir)

        # Generate demo script
        self._generate_demo_script(analysis_results, demo_dir)
    ...
    def _create_executive_summary(self, analysis_results: Dict[str, Any]) -> ExecutiveSummary:
        ...
        if "vulnerabilities" in analysis_results:
            ...
            critical_count = len(
                [
                    v
                    for v in vulns.get("memory_vulnerabilities", [])
    ...
    def _extract_threat_intelligence(
    ...
    def _generate_abstract(
        self, executive_summary: ExecutiveSummary, findings: List[Finding]
    ) -> str:
    ...
    def _generate_threat_intelligence_exports(
    ...
    def _generate_master_index(
        self, generated_reports: Dict[str, str], analysis_results: Dict[str, Any]
    ) -> str:
...
<body>
    ...
    def _generate_presentation_slides(
...
if __name__ == "__main__":
    ...
    sample_results = {
        ...
        "corporate_exposure": {
            "credentials_found": [{"type": "AWS API Key", "location": "config.js:42"}]
        },
        "threat_intelligence": {
            "iocs_extracted": [
                {
