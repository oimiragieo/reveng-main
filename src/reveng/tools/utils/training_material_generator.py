...
class TrainingContentGenerator:
    ...
    def __init__(self, output_dir: str = "training_materials"):
        ...
        self.jinja_env = Environment(
            loader=FileSystemLoader(str(self.output_dir / "templates")), autoescape=True
        )
        ...
        logger.info(
            f"Training content generator initialized with output directory: {self.output_dir}"
        )
...
"""
    ...
    def generate_security_awareness_module(
        self, topic: str, analysis_results: Dict[str, Any]
    ) -> TrainingModule:
        ...
        assessment_questions = [
            {
                ...
                "options": [
                    ...
                    {
                        "letter": "B",
                        "text": "Runtime encryption with external key management",
                    },
    ...
    def generate_case_study(
        self, analysis_results: Dict[str, Any], incident_type: str = "data_exposure"
    ) -> CaseStudy:
    ...
    def create_interactive_learning_module(
        self, topic: str, analysis_results: Dict[str, Any]
    ...
    def generate_training_curriculum(
        self, topics: List[str], analysis_results: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    sample_analysis_results = {
        ...
        "analysis_findings": [
            ...
            },
            {
                ...
                "description": "Sensitive data found in binary",
            },
        ],
    }
