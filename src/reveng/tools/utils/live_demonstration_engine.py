...
class LiveDemonstrationEngine:
    ...
    def __init__(self, output_dir: str = "live_demonstrations"):
        ...
        logger.info(
            f"Live demonstration engine initialized with output directory: {self.output_dir}"
        )

    def create_client_demonstration(
        self, client_type: str, analysis_results: Dict[str, Any]
    ) -> LiveDemonstration:
    ...
    def _create_executive_demonstration(
        self, demo_id: str, analysis_results: Dict[str, Any]
    ) -> LiveDemonstration:
        ...
        steps = [
            DemonstrationStep(
                ...
                interactive_elements=[
                    {
                        "type": "poll",
                        "question": "How confident are you in your current application security?",
                    }
                ],
            ...
            DemonstrationStep(
                ...
                interactive_elements=[
                    {"type": "real_time_results", "display": "credentials_found"},
                    {
                        ...
                        "inputs": ["data_sensitivity", "exposure_level"],
                    },
                ],
            ...
            DemonstrationStep(
                ...
                interactive_elements=[
                    ...
                    {
                        "type": "timeline",
                        "events": ["discovery", "exploitation", "breach", "recovery"],
                    },
                ],
            ...
            DemonstrationStep(
                ...
                interactive_elements=[
                    {"type": "priority_matrix", "axes": ["impact", "effort"]},
                    {
                        ...
                        "milestones": ["immediate", "short_term", "long_term"],
                    },
                ],
    ...
    def _create_technical_demonstration(
        self, demo_id: str, analysis_results: Dict[str, Any]
    ) -> LiveDemonstration:
    ...
    def _create_security_team_demonstration(
        self, demo_id: str, analysis_results: Dict[str, Any]
    ) -> LiveDemonstration:
    ...
    def _create_general_demonstration(
        self, demo_id: str, analysis_results: Dict[str, Any]
    ) -> LiveDemonstration:
    ...
    def execute_live_demonstration(
        self, demo: LiveDemonstration, progress_callback: Optional[Callable] = None
    ) -> Dict[str, Any]:
            ...
            materials.append(
                {
                    ...
                    "emphasis": (
                        "high"
                        if any(
                            keyword in talking_point.lower()
    ...
    def create_real_time_assessment(
        self, organization_name: str, applications: List[str]
    ) -> Dict[str, Any]:
    ...
    def _update_risk_metrics(
        self, assessment: Dict[str, Any], findings: List[Dict[str, Any]]
    ) -> None:
        ...
        total_score = (
            assessment["risk_metrics"]["high_severity"] * high_weight
    ...
    def create_portfolio_analysis(
        self, organization_name: str, applications: List[Dict[str, Any]]
    ) -> PortfolioAnalysis:
        ...
        portfolio_analysis = PortfolioAnalysis(
            ...
            compliance_status={
                "GDPR": (
                    "Non-compliant"
                    if any(f["risk_level"] == "critical" for f in critical_findings)
                    else "Compliant"
                ),
        ...
        portfolio_filename = (
            f"portfolio_{organization_name}_{datetime.now().strftime('%Y%m%d')}.json"
        )
