...
class UniversalOptimalBinaryAnalysis:
    ...
    def get_optimal_functions(self) -> List[Dict[str, Any]]:
        ...
        js_functions = [
            ...
            {
                "name": "js_serialize_object",
                "address": "0x1400026F0",
                "size": 192,
                "type": "js_serialization",
                "complexity": "high",
            },
        ]
