...
from ..ai.ai_enhanced_data_models import Evidence, EvidenceTracker, MITREMapping
...
class MITREAttackMapper:
    ...
    def map_techniques_comprehensive(
        self, decompiled_code: str = None, api_calls: List[str] = None
    ) -> MITREMapping:
...
def main():
    ...
    for tid in mapping.techniques:
        ...
        print(
            f"  {tid}: {details.get('name')} (Confidence: {mapping.confidence_scores.get(tid, 0):.2f})"
        )
