...
def setup_logging(
    ...
    if structured:
        console_formatter = StructuredFormatter(
            include_context=True, include_stack_trace=include_stack_trace
        )
    else:
...
def log_context(component: str, operation: str, **kwargs):
    ...
    context = LogContext(component=component, operation=operation, **kwargs)
...
def log_error_with_context(
    logger: REVENGLogger, error: Exception, context: Optional[LogContext] = None
):
