...
class InstallationVerifier:
    ...
    def check_python(self) -> bool:
        ...
        try:
            ...
            if version < (3, 9):
                self.errors.append(f"Python 3.9+ required, got {version.major}.{version.minor}")
                return False
    ...
    def suggest_fixes(self) -> List[str]:
        ...
        if not self.results["python"]:
            suggestions.append("Install Python 3.9+ from https://python.org")
