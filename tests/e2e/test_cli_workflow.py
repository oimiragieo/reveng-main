...
class TestCLIWorkflow:
    ...
    def test_cli_help_command(self):
        ...
        result = subprocess.run(
            ["python", "-m", "src.reveng.cli", "--help"], capture_output=True, text=True, timeout=30
        )
    ...
    @pytest.mark.e2e
    def test_cli_workflow_performance(
        self, mock_binary_file, temp_analysis_dir, performance_benchmark
    ):
