...
class TestBusinessLogicExtractor:
    ...
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._extract_data_flows"
    )
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._extract_file_operations"
    )
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._detect_report_generation"
    )
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._extract_network_operations"
    )
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._extract_database_operations"
    )
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._extract_security_features"
    )
    @patch(
        "src.reveng.analyzers.business_logic_extractor.BusinessLogicExtractor._analyze_behavioral_patterns"
    )
    def test_analyze_application_domain_success(
        self,
        mock_behavioral,
        mock_security,
        mock_database,
