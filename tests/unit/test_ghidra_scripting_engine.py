...
class TestGhidraScriptEngine:
    ...
    def setup_method(self):
        ...
        self.script_engine = GhidraScriptEngine(self.ghidra_headless_path, self.ghidra_scripts_path)
    ...
    def test_run_ghidra_command_failure(self):
        ...
        result = self.script_engine._run_ghidra_command(
            [str(self.temp_dir), "test_project", "-import", str(test_binary), "-invalid-argument"]
        )
    ...
    def test_execute_python_script_success(self):
        ...
        # Execute script
        result = self.script_engine.execute_python_script(script_path, test_binary, "test_project")
    ...
    def test_execute_java_script_success(self):
        ...
        script_path.write_text(
            'public class TestScript { public static void main(String[] args) { System.out.println("Java script executed"); } }'
        )
        ...
        # Execute script
        result = self.script_engine.execute_java_script(script_path, test_binary, "test_project")
    ...
    def test_execute_java_script_failure(self):
        ...
        script_path.write_text(
            "public class FailingScript { public static void main(String[] args) { System.out.println(nonexistent_variable); } }"
        )
    ...
    def test_batch_analyze_success(self):
        ...
        results = self.script_engine.batch_analyze(test_binaries, script_path, "batch_project")
    ...
    def test_script_result_properties(self):
        ...
        result = ScriptResult(
            success=True, stdout="test output", stderr="test error", output_path=Path("test.xml")
        )
    ...
    def test_export_result_properties(self):
        ...
        result = ExportResult(success=True, output_path=Path("test.xml"), message="test message")
