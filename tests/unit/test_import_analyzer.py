...
class TestImportAnalyzer:
    ...
    def test_analyze_imports_success(
        ...
        # Setup mocks
        mock_import_table.return_value = {
            "pe_header": {},
            "import_table": {},
            "import_descriptors": [],
        }
    ...
    def test_calculate_risk_score(self):
        ...
        suspicious_apis = [
            APIInfo(
                ...
                dll="malware.dll",
                category=APICategory.UNKNOWN,
                suspicious_level=SuspiciousLevel.CRITICAL,
                description="",
            ),
            APIInfo(
                name="bypass",
                dll="malware.dll",
                category=APICategory.UNKNOWN,
                suspicious_level=SuspiciousLevel.HIGH,
                description="",
            ),
        ]
