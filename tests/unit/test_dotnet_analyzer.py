...
class TestDotNetAnalyzer:
    ...
    def test_analyze_assembly_success(
        self,
        mock_pe_sections,
        mock_api_calls,
        mock_obfuscation,
        ...
        # Setup mocks
        mock_assembly.return_value = Mock(
            name="TestApp",
            version="1.0.0",
            culture="",
            public_key_token="",
    ...
    def test_detect_gui_framework_winforms(self):
        ...
        strings = ["System.Windows.Forms", "Form", "Button", "TextBox", "MessageBox"]
    ...
    def test_detect_gui_framework_wpf(self):
        """Test WPF detection"""
        strings = ["System.Windows", "XAML", "WPF", "PresentationFramework"]
    ...
    def test_detect_gui_framework_console(self):
        ...
        strings = ["Console.WriteLine", "Console.Read", "System.Console"]
