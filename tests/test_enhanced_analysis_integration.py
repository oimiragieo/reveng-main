...
from tools.enhanced_config_manager import EnhancedAnalysisConfiguration, EnhancedConfigManager
...
class TestEnhancedAnalysisIntegration(unittest.TestCase):
    ...
    def test_reveng_analyzer_with_enhanced_features(self):
        ...
        analyzer = REVENGAnalyzer(
            binary_path=str(self.test_binary), check_ollama=False, enhanced_features=features
        )
    ...
    def test_enhanced_analysis_steps_execution(self, mock_subprocess):
        ...
        with (
            patch("tools.corporate_exposure_detector.CorporateExposureDetector") as mock_ced,
            ...
            mock_dg.return_value.create_demonstration_package.return_value = Mock(components=[])
    ...
    def test_enhanced_analysis_error_handling(self):
        ...
        with patch(
            "tools.corporate_exposure_detector.CorporateExposureDetector",
...
class TestEnhancedConfigurationManager(unittest.TestCase):
    ...
    def test_configuration_validation(self):
        ...
        self.assertTrue(
            any("Max concurrent analyses must be positive" in issue for issue in issues)
        )
...
class TestPerformanceBenchmarks(unittest.TestCase):
    ...
    def test_enhanced_analysis_performance(self):
        ...
        with (
            ...
            mock_dg.return_value.create_demonstration_package.side_effect = (
                lambda *args, **kwargs: Mock(components=[])
            )
