...
sample_results = {
    ...
    "threat_intelligence": {"apt_attribution": "APT29", "confidence": 0.85, "iocs_found": 12},
}
...
print(
    f"Campaign summary generated with {campaign['content_summary']['social_media_posts']} social media posts, {campaign['content_summary']['blog_posts']} blog posts, and {campaign['content_summary']['presentations']} presentations"
)
