...
class TestAIEnhancedAnalyzer(unittest.TestCase):
    ...
    def test_enhanced_analysis_config(self):
        ...
        config = EnhancedAnalysisConfig(
            enable_corporate_exposure=False, ai_provider="openai", confidence_threshold=0.9
        )
...
class TestEnhancedConfigManager(unittest.TestCase):
    ...
    def test_config_validation(self):
        ...
        self.assertGreater(len(issues), 0)
        self.assertTrue(
            any("confidence threshold must be between 0 and 1" in issue for issue in issues)
        )
...
class TestEnhancedHealthMonitor(unittest.TestCase):
    ...
    def test_health_metric_dataclass(self):
        ...
        # Test basic metric
        metric = HealthMetric(
            name="test_metric", value="test_value", status="healthy", timestamp=datetime.now()
        )
...
def run_unit_tests():
    ...
    # Add test classes
    test_classes = [TestAIEnhancedAnalyzer, TestEnhancedConfigManager, TestEnhancedHealthMonitor]
