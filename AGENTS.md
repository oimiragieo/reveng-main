...
- Living ops index: root `backlog.md` (not `docs/BACKLOG.md`). Latest CEO: `docs/architecture/ceo-update-2026-08-09-wave5.md` (Wave 5 fingerprint attribution — **not** exe decode / Phase 6 / enterprise GA; Wave 4: `ceo-update-2026-08-09-wave4.md`).
