...
- Lessons: `docs/architecture/lessons-learned-scope-c-2026-08.md` (**L1–L48**)
...
## Hard-won facts (through 2026-08-09 Waves 1–2)
...
- Research open: **R-RALPH-2**; **EDGE-RECOMPILE-DIFF-1**; **R-MCP-ANNOTATION-1** partial (denylist only). Wave 0 **CLOSEOUT-W0 done** (PR #131). Wave 1 **merged** (PR #132). Wave 2 **PR #133 OPEN** (Sol gate). Issue **#101** still **OPEN**.
- Fable/Sol via CLI; inline Sol packets; `git -c user.name/email` from `git log -1`; no stash across worktrees.
- Cursor Task quota can exhaust — prefer `codex exec` / `claude -p` / parent tg over waiting on dead Tasks.
...
- Merge Wave 2 (#133) only after Sol PASS / explicit CEO override
