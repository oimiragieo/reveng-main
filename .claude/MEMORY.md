...
- JS recovery full-oracle 100% — blocked by unique-token tombstones + weak shared-token collisions; next levers: scaled LLM tags, graph priors, optional Sinkhorn/QAP
